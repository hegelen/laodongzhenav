...
const blogYearsData = {  
    ...
    '08': [{name:'阿呆生活志', url:'/go.htm?url=https://qsir.cn/', rss:'https://qsir.cn/feed'}, {name:'懋和道人', url:'/go.htm?url=https://www.dao.js.cn/', rss:'https://www.dao.js.cn/feed'}, {name:'杜郎俊赏', url:'/go.htm?url=https://dujun.io/', rss:'https://dujun.io/feed'}, {name:'虹墨', url:'/go.htm?url=https://www.imaegoo.com/', rss:'https://www.imaegoo.com/feed'}, {name:'军', url:'/go.htm?url=https://me.xu19.com/', rss:'https://me.xu19.com/feed'}, {name:'小气的神', url:'/go.htm?url=https://mdong.org/', rss:'https://mdong.org/feed'}, {name:'蓝卡', url:'/go.htm?url=https://www.lanka.cn/', rss:'https://www.lanka.cn/feed'},{name:'龙Ge笔迹', url:'/go.htm?url=https://www.izhailong.com/', rss:'https://www.izhailong.com/feed'}, {name:'刘荣星', url:'/go.htm?url=https://www.liurongxing.com/', rss:'https://www.liurongxing.com/feed'}, {name:'纸短情长', url:'/go.htm?url=https://www.gtdstudy.com/', rss:'https://www.gtdstudy.com/feed'}, {name:'小桥流水人家', url:'/go.htm?url=https://baiqiuyi.com/', rss:'https://baiqiuyi.com/feed'}   , {name:'有氧呼吸', url:'/go.htm?url=https://www.oxy.one/', rss:'https://www.oxy.one/feeds/posts/default'}  ],
