...
const forumData = {
    ...
    '26': [{name:'摸鱼论坛', url:'https://mylt.net/'}, {name:'mjjzz', url:'https://www.mjjzz.com/'}, {name:'博客之家论坛', url:'https://52blog.cn/'}, {name:'侠客岛', url:'https://bbs.hk0.cc/'}, {name:'虚拟资源爱好者的乌托邦', url:'https://zzoo.im/'}, {name:'blog.do', url:'https://bbs.blog.do/'}, {name:'jiza', url:'https://jiza.net'} ]
};
