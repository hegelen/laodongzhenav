...
const blogNavData = {
    ...
    '26': [{name:'若梦博客', url:'/go.htm?url=http://www.rmbk.cc/'}, {name:'拾趣博客导航', url:'/go.htm?url=https://s7.fan/'}, {name:'有个站', url:'/go.htm?url=https://www.ygz.ink/'}, {name:'大佬论坛摸鱼', url:'/go.htm?url=https://www.dalao.net/index-1-2.htm'}, {name:'周松松博客精选', url:'/go.htm?url=https://zhousongsong.com/daohang/'}]
};
