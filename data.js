...
const blogNavData = {
  ...
  '26': [{name:'若梦博客', url:'/go.htm?url=http://www.rmbk.cc/'}, {name:'有个站', url:'/go.htm?url=https://www.ygz.ink/'}, {name:'大佬论坛摸鱼', url:'/go.htm?url=https://www.dalao.net/index-1-2.htm'}, {name:'好站网', url:'/go.htm?url=https://haozhan.wang/'} , {name:'壹個博客', url:'/go.htm?url=https://oneblog.net/'}  , {name:'博客圈子', url:'/go.htm?url=https://bkqz.cn/'}  , {name:'笔记博客', url:'/go.htm?url=https://noteblog.cn/'}   ]
};
