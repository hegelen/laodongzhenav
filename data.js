...
const forumData = {
    ...
    '26': [{name:'摸鱼论坛', url:'https://mylt.net/'}, {name:'mjjzz', url:'https://www.mjjzz.com/'}, {name:'博客之家论坛', url:'https://52blog.cn/'}, {name:'侠客岛', url:'https://bbs.hk0.cc/'}, {name:'虚拟资源爱好者的乌托邦', url:'https://zzoo.im/'}, {name:'blog.do', url:'https://bbs.blog.do/'}, {name:'jiza', url:'https://jiza.net'}  , {name:'middlefun', url:'https://www.middlefun.com/'}   , {name:'260站长论坛', url:'https://www.260.cn/'} ]
};
...
const blogNavData = {
  ...
  '26': [{name:'若梦博客', url:'http://www.rmbk.cc/'}, {name:'有个站', url:'https://www.ygz.ink/'}, {name:'大佬论坛摸鱼', url:'https://www.dalao.net/index-1-2.htm'}, {name:'好站网', url:'https://haozhan.wang/'}  , {name:'博客圈子', url:'https://bkqz.cn/'}  , {name:'聚合文摘', url:'http://maorongwanju.cn/'}  , {name:'utc8times博客俱乐部', url:'https://utc8times.elsetech.app/'}    ]
};
