...
const blogYearsData = {  
    ...
    '11': [{name:'耳朵的主人', url:'/go.htm?url=https://www.edzbe.com/', rss:'https://www.edzbe.com/feed'}, {name:'老孙', url:'/go.htm?url=https://www.imsun.org/', rss:'https://www.imsun.org/feed'}, {name:'小癞子', url:'/go.htm?url=https://justyy.com/', rss:'https://justyy.com/feed'}, {name:'陪她去流浪', url:'/go.htm?url=https://blog.twofei.com/', rss:'https://blog.twofei.com/feed'}, {name:'罗磊', url:'/go.htm?url=https://luolei.org/', rss:'https://luolei.org/feed'}, {name:'phodal', url:'/go.htm?url=https://www.phodal.com/blog/', rss:'https://www.phodal.com/feed'},{name:'周涛', url:'/go.htm?url=https://www.ediok.cn/', rss:'https://www.ediok.cn/feed'}, {name:'Verne', url:'/go.htm?url=https://blog.einverne.info/', rss:'https://blog.einverne.info/feed.xml'}  , {name:'forecho', url:'/go.htm?url=https://blog.forecho.com/', rss:'https://blog.forecho.com/atom.xml'}   ],
