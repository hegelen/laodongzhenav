...
const blogYearsData = {  
    ...
    '26': [{name:'华立', url:'/go.htm?url=https://www.renhuali.cn/', rss:'https://www.renhuali.cn/feed'}, {name:'悦已', url:'/go.htm?url=https://yueji.org/', rss:'https://yueji.org/feed'}, {name:'麦子的思绪', url:'/go.htm?url=https://mzdsx.com/', rss:'https://mzdsx.com/feed/'} , {name:'一万先生', url:'/go.htm?url=https://mryvan.com/', rss:'https://mryvan.com/rss.xml'} , {name:'寻生纪', url:'/go.htm?url=https://www.iseeklife.com/', rss:'https://www.iseeklife.com/feed'}  ]
};
